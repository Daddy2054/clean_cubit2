...
/// @nodoc
abstract class _$$ToDoAddStateImplCopyWith<$Res>
    implements $ToDoAddStateCopyWith<$Res> {
  factory _$$ToDoAddStateImplCopyWith(
          _$ToDoAddStateImpl value, $Res Function(_$ToDoAddStateImpl) then) =
      __$$ToDoAddStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool isLoading,
...
/// @nodoc
class __$$ToDoAddStateImplCopyWithImpl<$Res>
    extends _$ToDoAddStateCopyWithImpl<$Res, _$ToDoAddStateImpl>
    implements _$$ToDoAddStateImplCopyWith<$Res> {
  __$$ToDoAddStateImplCopyWithImpl(
      _$ToDoAddStateImpl _value, $Res Function(_$ToDoAddStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ToDoAddStateImpl(
      isLoading: null == isLoading
          ? _value.isLoading
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$ToDoAddStateImpl implements _ToDoAddState {
  const _$ToDoAddStateImpl(
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ToDoAddStateImplCopyWith<_$ToDoAddStateImpl> get copyWith =>
      __$$ToDoAddStateImplCopyWithImpl<_$ToDoAddStateImpl>(this, _$identity);
}
...
abstract class _ToDoAddState implements ToDoAddState {
  const factory _ToDoAddState(
      ...
      final String? errorMsg}) = _$ToDoAddStateImpl;
